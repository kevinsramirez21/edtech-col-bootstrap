export type Pais = 'Colombia' | 'Chile' | 'México' | 'Brasil' | 'Argentina' | 'Perú' | 'Cuba' | 'Virtual';
...
export const eventosLatam2026: Evento[] = [
  ...
  },
  {
    ...
    modalidad: 'Virtual',
    estado: 'Confirmado',
    enlace: 'https://educaciondigital.entropiaeducativa.com/',
    descripcion: 'Escenarios emergentes para la investigación y la educación del futuro.',
    organizador: 'Entropía Educativa',
  },
  {
  ...
  // Febrero 2026
  {
    ...
    modalidad: 'Híbrido',
    estado: 'Confirmado',
    enlace: 'https://www.congresouniversidad.cu/',
    descripcion: 'Congreso internacional de educación superior organizado por Cuba.',
    organizador: 'Ministerio de Educación Superior de Cuba',
    notas: 'Formato híbrido disponible.',
  },
  {
