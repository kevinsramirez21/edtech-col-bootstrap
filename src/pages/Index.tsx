  ...
  return <>
      ...
      <Section className="py-10 sm:py-14 lg:py-20 bg-gradient-to-br from-primary-700 via-primary-900 to-primary-700 text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-30 hidden sm:block">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_70%,rgba(247,60,92,0.15),transparent_60%)]"></div>
        </div>
        
        {/* Floating Elements */}
        <div className="absolute inset-0 overflow-hidden hidden sm:block">
          <div className="absolute top-10 left-10 w-24 h-24 bg-accent-brand/20 rounded-full blur-2xl animate-float"></div>
          <div className="absolute bottom-20 right-20 w-32 h-32 bg-white/10 rounded-full blur-3xl animate-float animation-delay-1000"></div>
          <div className="absolute top-1/2 left-1/4 w-20 h-20 bg-primary-700/30 rounded-full blur-2xl animate-float animation-delay-500"></div>
        </div>
        
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
          {/* Badge */}
          <div className="flex justify-center mb-4 sm:mb-6 animate-fade-in-up">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-accent-brand/20 backdrop-blur-sm rounded-full text-sm font-semibold border border-accent-brand/30">
          ...
          <div className="text-center mb-6 sm:mb-10">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 sm:mb-6 leading-tight animate-fade-in-up animation-delay-200">
              ...
              <span className="text-accent-brand">Latinoamérica</span>
            </h2>
            <div className="w-20 sm:w-28 h-1 bg-gradient-to-r from-accent-brand to-white mx-auto mb-4 sm:mb-6 rounded-full animate-fade-in-up animation-delay-300"></div>
            <p className="text-sm sm:text-base md:text-lg lg:text-xl max-w-4xl mx-auto text-white/90 leading-relaxed font-medium animate-fade-in-up animation-delay-400">
              EdTech Hub Latam conecta ecosistemas educativos de <strong className="text-accent-brand">Colombia, Argentina, México, Chile, Perú, Brasil</strong> y más países para acelerar la transformación de la educación en la región.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-4 sm:gap-6 max-w-4xl mx-auto mb-8 sm:mb-10">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 sm:p-6 text-center border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105 animate-fade-in-up animation-delay-500">
              <div className="w-12 h-12 sm:w-14 sm:h-14 mx-auto mb-3 sm:mb-4 rounded-xl bg-accent-brand/20 flex items-center justify-center">
                <MapPin className="w-6 h-6 sm:w-7 sm:h-7 text-accent-brand" />
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 sm:p-6 text-center border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105 animate-fade-in-up animation-delay-600">
              <div className="w-12 h-12 sm:w-14 sm:h-14 mx-auto mb-3 sm:mb-4 rounded-xl bg-accent-brand/20 flex items-center justify-center">
                <Handshake className="w-6 h-6 sm:w-7 sm:h-7 text-accent-brand" />
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 sm:p-6 text-center border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105 animate-fade-in-up animation-delay-700">
              <div className="w-12 h-12 sm:w-14 sm:h-14 mx-auto mb-3 sm:mb-4 rounded-xl bg-accent-brand/20 flex items-center justify-center">
                <Rocket className="w-6 h-6 sm:w-7 sm:h-7 text-accent-brand" />
              </div>
          ...
          <div className="text-center animate-fade-in-up animation-delay-800">
            <a 
              ...
              className="inline-flex items-center justify-center gap-2 sm:gap-3 bg-accent-brand hover:bg-accent-brand/90 text-white font-bold px-6 sm:px-8 py-3 sm:py-4 rounded-xl shadow-2xl shadow-accent-brand/40 hover:shadow-accent-brand/60 transition-all duration-500 hover:scale-105 text-sm sm:text-base lg:text-lg group"
            >
